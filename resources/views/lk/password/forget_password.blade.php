		...
		<div class="container">
			<div class="max-w-[640px] mt-12 mx-auto p-6 xs:p-8 md:p-12 2xl:p-16 rounded-[20px] bg-purple">
				...
				<form class="space-y-3" method="post" action="">
					<x-form.text-input name="email" type="email" required placeholder="E-mail для восстановления"></x-form.text-input>
					<x-form.form-red-button text="Сбросить пароль"></x-form.form-red-button>
				</form>
				<div class="space-y-3 mt-5">
					<div class="text-xxs md:text-xs text-center">
						<a href="{{ route('register.index') }}" class="text-white hover:text-white/70 font-bold">
