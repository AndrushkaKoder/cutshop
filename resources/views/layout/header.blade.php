		...
		<div class="header-inner flex items-center justify-between lg:justify-start">
			...
			<div class="header-menu grow hidden lg:flex items-center ml-8 mr-8 gap-8">
				...
				<nav class="hidden 2xl:flex gap-8">
					<a href="index.html" class="text-black hover:text-pink font-bold">Главная</a>
					<a href="catalog.html" class="text-black hover:text-pink font-bold">Каталог товаров</a>
					<a href="cart.html" class="text-black hover:text-pink font-bold">Корзина</a>
				</nav>
			</div>
			...
			<div class="header-actions flex items-center gap-3 md:gap-5">
						...
						>
							...
							<div class="mt-6">
								<a href="#" class="inline-flex items-center text-body hover:text-pink">
									...
									<a href="{{ route('user.logout') }}" class="ml-2 font-medium">Выйти</a>
								</a>
							</div>
						</div>
					</div>
				...
				<a href="cart.html" class="flex items-center gap-3 text-pink">
